...
; (function($) {
    ...
    $.fn.dynamicTable = function(options) {
        var settings = $.extend({}, {
            ...
            buttons: {
                addButton: '<button type="submit" class="actionbutton" name="submitKlant"><i class="fa fa-plus plus"></i></button>',
                cancelButton: '<input type="button" value="Cancel" class="btn btn-primary" />', //todo add button
                deleteButton: ' <button class="actionbutton" name="deleteKlant"><i class="fas fa-trash-alt trash"></i></button><?php } ?>',
                editButton: '<button type="submit" class="actionbutton" name="editArtikel" value="edit"><i class="fas fa-pen pen"></i></button>',
                saveButton: '<input type="button" value="Save" class="btn btn-success" />', //todo add button
            },
            columns: [],
            data: [],
        ...
        var populateActionButtons = function(tableRow, addButton, cancelButton, deleteButton, editButton, saveButton) {
            ...
            if (saveButton) {
                ...
                $(localButton).attr('data-codeapi-savecommand', 'true');  //todo: add ajax
                $(localButton).hide();
                $(tableCell).append(' ');
            ...
            if (editButton) {
                ...
                $(localButton).attr('data-codeapi-editcommand', 'true'); //todo: add ajax
                $(tableCell).append(' ');
                $(tableCell).append($(localButton));
            ...
            if (deleteButton) {
                ...
                $(localButton).attr('data-codeapi-deletecommand', 'true');  //todo: add ajax
                $(tableCell).append(' ');
                $(tableCell).append($(localButton));
