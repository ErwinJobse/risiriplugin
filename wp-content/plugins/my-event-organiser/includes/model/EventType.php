...
class EventType{
    ...
    public function save($input_array){
        try {
            ...
            $wpdb->query($wpdb->prepare("INSERT INTO `". $wpdb->prefix
                ."meo_event_types` ( `name`, `description`)".
            ...
            echo '</pre>';
            //*/
            //echo 'Insert name and description for this types:"'.$input_array['name'].
    ...
    public function getEventTypeList(){
        ...
        $result_array = $wpdb->get_results( "SELECT * FROM `". $wpdb->prefix . "meo_event_types` ORDER BY `id_event_types`", ARRAY_A);
...
// New object
            ...
            $cat->setId($array['id_event_types']);
    ...
    /**
     *
     * @param type $id Id of the event types
     */
    ...
    /**
     *
     * @param type $name name of the event types
     */
    ...
    /**
     *
     * @param type $desc The help text of the event types
     */
    ...
    /**
     *
     * @return string The name of the Event types
     */
    ...
    private function getTableName(){
        ...
        global $wpdb;
        return $table = $wpdb->prefix . "meo_event_types";
    }
    /**
     *
    ...
    public function update($input_array){
        ...
        try {
            ...
            $table_fields = array( 'id_event_types', 'name' , 'description');
            $data_array = array();
            ...
            $wpdb->query($wpdb->prepare("UPDATE ".$this->getTableName().
                ...
                "WHERE
`wp_meo_event_types`.`id_event_types` =%d;",$input_array['name'],
            ...
            array( 'id_event_types' => $input_array['id']), // Where
...
// therefore not be changed!
                if (!empty($table_data)){
                    unset($table_data['id_event_types']);
                }
                break;
            // Remove
        }
    ...
    public function delete($input_array){
        ...
        try {
           ...
           "` WHERE `id_event_types` = %d", $input_array['id']);
            // Execute query:
            $wpdb->query( $query );
            /*/
            // Delete row by provided id (Wordpress style)
            $wpdb->delete( $this->getTableName(),
                array( 'id_event_types' => $input_array['id'] ),
                array( '%d' ) ); // Where format
            //*/
